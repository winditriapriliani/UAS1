    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <p>Pesanan anda berhasil di check out, selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BCA nomor rekening : <br> 
                    420-069-6969</strong>, dengan nominal : <strong>Rp. {{ number_format($pesanan->jumlah_harga+$pesanan->kode) }}</strong></p>
                </div>
            </div>
        </div>
    </div>
